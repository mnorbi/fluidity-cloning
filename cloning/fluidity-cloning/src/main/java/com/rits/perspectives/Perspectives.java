...
public class Perspectives
{
	 ...
	 */
	public <T, E extends T> E viewAs(final Class<E> c, final T o, Set<Class<?>> activationGroups)
	{
		...
		final E newInstance = cloner.fastCloneOrNewInstance(c, activationGroups);
		cloner.copyPropertiesOfInheritedClass(o, newInstance, activationGroups);
		return newInstance;
	}
	 ...
	 */
	public <I, NI extends I, T extends Collection<I>, E extends Collection<NI>> E viewCollectionAs(final E newCollection, final Class<NI> perspectiveCollectionItemClass, final T currentCollection, Set<Class<?>> activationGroups)
	{
		if (currentCollection == null) return null;
		for (final I item : currentCollection)
		{
			final NI newItem = viewAs(perspectiveCollectionItemClass, item, activationGroups);
